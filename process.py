...
with open('model/random_forest_squat.pkl','rb') as f:
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            try:
                ...
                form_class = model_deadlift.predict(X)[0]
                form_prob = model_deadlift.predict_proba(X)[0]
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            try:
                ...
                X = pd.DataFrame([pose_row])
                form_class = model_squat.predict(X)[0]
                form_prob = model_squat.predict_proba(X)[0]
                print(form_class, form_prob)
